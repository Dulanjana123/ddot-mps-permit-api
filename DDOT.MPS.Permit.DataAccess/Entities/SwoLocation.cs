...
[Table("swo_locations")]
[Index("SwoLocationId", Name = "IX_swo_location_id")]
public partial class SwoLocation
{
    [Key]
    [Column("swo_location_id")]
    public int SwoLocationId { get; set; }
