...
[Table("pdrm_application_minutes")]
[Index("PdrmAppMinuteId", Name = "IX_pdrm_app_minute_id")]
public partial class PdrmApplicationMinute
{
    [Key]
    [Column("pdrm_app_minute_id")]
    public int PdrmAppMinuteId { get; set; }
    ...
    [InverseProperty("PdrmApplicationMinutes")]
